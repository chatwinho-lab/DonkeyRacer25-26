...
MAX_STEERING_ANGLE = (
    3.141592653589793 / 4
)  # for car-like robot; maximum steering angle in radians (corresponding to tire angle at steering == -1)
...
PWM_STEERING_THROTTLE = {
    ...
    "STEERING_CENTER_PWM": 375,  # add this to define the straight-forward position
...
HAVE_ODOM_2 = (
    False  # Do you have a second odometer/encoder as in a differential drive robot.
)
...
ENCODER_DEBOUNCE_NS = (
    0  # nanoseconds to wait before integrating subsequence encoder pulses.
)
...
TACHOMETER_MODE = (
    FORWARD_REVERSE  # FORWARD_ONLY, FORWARD_REVERSE or FORWARD_REVERSE_STOP
)
...
MM_PER_TICK = (
    WHEEL_RADIUS * 2 * 3.141592653589793 * 1000 / ENCODER_PPR
)  # How much travel with a single encoder tick, in mm. Roll you car a meter and divide total ticks measured by 1,000
...
PATH_SEARCH_LENGTH = (
    None  # number of points to search for closest point, None to search entire path
)
PATH_LOOK_AHEAD = (
    1  # number of points ahead of the closest point to include in cte track
)
PATH_LOOK_BEHIND = (
    1  # number of points behind the closest point to include in cte track
)
