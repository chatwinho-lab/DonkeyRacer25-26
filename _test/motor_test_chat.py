...
parser.add_argument(
    "-s", "--servo", type=int, default=0, help="Servo channel (default: 0)"
)
parser.add_argument(
    "-i",
    "--initialize",
    type=int,
    default="0",
    help="Is the motor running for the first time since being switched on? (default: 0)",
)
...
# ARM THE THING
print("arming...")
pca.channels[0].duty_cycle = 5897
time.sleep(1)
pca.channels[1].duty_cycle = 5897
time.sleep(2)


# channels[0] is the servo
# channels[1] is the motor
...
print("going...")
pca.channels[0].duty_cycle = int(MAXD * 0.12)
time.sleep(1)
pca.channels[1].duty_cycle = int(MAXD * 0.1)
time.sleep(1)
